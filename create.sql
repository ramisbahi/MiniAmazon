...
CREATE TABLE Items(product_id INTEGER NOT NULL,
                  seller_username VARCHAR(30) NOT NULL REFERENCES Buyers(username),
                  category VARCHAR(80), /*Sports, */
...
CREATE TABLE inorder(product_id INTEGER NOT NULL,
                    seller_username VARCHAR(30) NOT NULL,
...
CREATE TABLE inwishlist(product_id INTEGER NOT NULL,
                    seller_username VARCHAR(30) NOT NULL,
...
CREATE TABLE incart(product_id INTEGER NOT NULL,
                    seller_username VARCHAR(30) NOT NULL,
                    buyer_username VARCHAR(30) NOT NULL REFERENCES Buyers(username) CHECK(buyer_username <> seller_username),
