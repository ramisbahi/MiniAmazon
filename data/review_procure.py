...
category_name = 'Appliances' # custom name in "category" column

data = []
with open('reviewdata/meta_' + category + '.json') as f:
    for l in f:
...
df3['condition'] = np.random.choice(conditions, len(df3), p=[0.5, 0.2, 0.1, 0.1, 0.1])
